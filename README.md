## Tasmota KNX  [![Tasmota Build](https://github.com/ascillato/Tasmota_KNX/workflows/Tasmota%20Build/badge.svg?branch=development)](https://github.com/ascillato/Tasmota_KNX/tree/development/build_output/firmware) 
...
Each device has a physical address (like a fixed IP) as **1 . 1 . 1** and that address is used for configuration purposes.
